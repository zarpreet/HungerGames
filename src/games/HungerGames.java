...
public void eliminateDueler(DuelPair pair) {
    ...
    if (pair.getPerson1() == null || pair.getPerson2() == null) {
        ...
        if (pair.getPerson1() != null) {
            returnDuelerToDistrict(pair.getPerson1());
        }
        if (pair.getPerson2() != null) {
            returnDuelerToDistrict(pair.getPerson2());
        }
    } else {
        ...
        // Check the population sizes of the winner's and loser's districts
        checkDistrictPopulation(winner.getDistrictID());
        checkDistrictPopulation(loser.getDistrictID());
    }
}
